...
<div className="relative md:absolute md:right-6">

  {/* BUTTON (si genres) */}
  <button
    onClick={() => setOpenMonths(!openMonths)}
    className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-md text-sm hover:bg-gray-700 transition"
  >
    {selectedMonth}
  </button>

  {/* DROPDOWN (si genres menu) */}
  {openMonths && (
    <div className="absolute right-0 mt-2 w-44 bg-[#111] border border-gray-700 rounded-md shadow-lg z-50">
      ...
      {months.map((m, i) => (
        <div
          ...
          className="px-4 py-2 text-sm cursor-pointer hover:bg-red-600 transition"
        >
          {m}
        </div>
      ))}
    ...
    {/* FOOTER */}
<footer className="mt-16 bg-[#2b2b2b] px-6 sm:px-10 md:px-16 py-10 text-gray-300">

  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-xs sm:text-sm text-center sm:text-left">

    {/* MOVIES */}
    <div>
      <h3 className="text-white font-bold mb-3">MOVIES</h3>
      <a className="block mb-1 hover:text-red-500">Top Movies</a>
      <a className="block mb-1 hover:text-red-500">Now Playing</a>
      <a className="block hover:text-red-500">Coming Soon</a>
    </div>

    {/* CINEMAS */}
    <div>
      <h3 className="text-white font-bold mb-3">CINEMAS</h3>
      <a className="block mb-1 hover:text-red-500">Prishtine</a>
      <a className="block hover:text-red-500">Tirane</a>
    </div>

    {/* INFORMATION */}
    <div>
      <h3 className="text-white font-bold mb-3">INFORMATION</h3>
      <a className="block mb-1 hover:text-red-500">Technology</a>
      <a className="block mb-1 hover:text-red-500">Gift Card Info</a>
      <a className="block mb-1 hover:text-red-500">Bonus Card Info</a>

      <h3 className="text-white font-bold mt-5 mb-3">B2B</h3>
      <a className="block mb-1 hover:text-red-500">Rent a hall</a>
      <a className="block hover:text-red-500">Advertise</a>
    </div>

    {/* FOLLOW */}
    <div>
      <h3 className="text-white font-bold mb-3">FOLLOW</h3>
      <a className="block mb-1 hover:text-red-500">Instagram</a>
      <a className="block hover:text-red-500">TikTok</a>
    </div>

    {/* APPS */}
    <div className="flex flex-col items-center sm:items-start">
      <h3 className="text-white font-bold mb-3">APPS</h3>

      <img
        className="w-[130px] sm:w-[140px] md:w-[150px] mb-2"
        src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"
      />

      <img
        className="w-[130px] sm:w-[140px] md:w-[150px]"
  ...
  {/* bottom line */}
  <div className="mt-8 border-t border-gray-600 pt-4 text-center text-gray-400 text-[11px] sm:text-xs">
    © {new Date().getFullYear()} CinePlay
  </div>
